...
namespace ti
{
	class WorkerContext : public StaticBoundObject
	{
	public:
		WorkerContext(Host *host, SharedKObject scope, SharedKObject worker);
	...
	private:
		...
		void OnMessageAttached(SharedKMethod onmessage);
